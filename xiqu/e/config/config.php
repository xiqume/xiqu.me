...
$ecms_config['db']['dbpassword']='a3d6e2bd64';	//数据库密码
$ecms_config['db']['dbname']='xiqu';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='QHn2uuTrB2SMaphePEmuyFp5NXNzqm';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='cslqy';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='hupaj';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='Gr2AfhN22RUnYabX7LQXedTfi6ryu3';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='faSjus8zJTd5xPJD2SpW873hHhHDYV';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'bakdbpath'=>'bdata',
'bakdbzip'=>'zip',
'downpass'=>'NbdtZuhawmyCauVyPJqa',
'filechmod'=>1,
'loginkey_ok'=>0,
'tbname'=>'download',
'limittype'=>0,
'redodown'=>1,
'downsofttemp'=>'[ <a href=\"[!--true.down.url--]\" target=\"_blank\">[!--down.name--]</a> 扣下载点数<em>[!--fen--]</em>个]',
'onlinemovietemp'=>'[ <a href=\"#ecms\" onclick=\"window.open(\'[!--down.url--]\',\'\',\'width=300,height=300,resizable=yes\');\">[!--down.name--]</a> ]',
'lctime'=>1222406370,
'candocode'=>1,
'opennotcj'=>0,
'listpagetemp'=>'[!--pagelink--]',
'reuserpagenum'=>50,
'revotejsnum'=>100,
'readjsnum'=>100,
'qaddtran'=>1,
...
'keytog'=>0,
'keytime'=>30,
'keyrnd'=>'Amsx8Rx3vMTBP9fYhBJBQXgfN9WkvF',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/jingju/\">京剧</a>&nbsp;|&nbsp;<a href=\"/yuju/\">豫剧</a>&nbsp;|&nbsp;<a href=\"/qinqiang/\">秦腔</a>&nbsp;|&nbsp;<a href=\"/pingju/\">评剧</a>&nbsp;|&nbsp;<a href=\"/free/\">免费视频</a>&nbsp;|&nbsp;<a href=\"/online/\">在线试看</a>&nbsp;|&nbsp;<a href=\"/help/\">帮助中心</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',movie,shop,pay,rss,pl,print,fieldand,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
