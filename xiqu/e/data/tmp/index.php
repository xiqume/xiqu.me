...
<meta name="keywords" content="戏曲,戏剧,戏曲下载,戏曲免费下载,戏曲视频下载,戏曲MP3下载" />
<meta name="description" content="戏曲迷是一个专业的戏曲资源收集网站，提供全国各地戏曲资源，包括戏曲视频下载、戏曲MP3下载、戏曲在线观看、戏曲介绍等内容。网站戏曲剧种全，资源多，下载方便，适合各种插卡式收音机、音箱、唱戏机等。" />
...
<div class="content-wrap">
	<div class="content">
		<div class="layout clearfix">
			<div class="mod hot-down">
	        	<div class="mod-hd">
	        		<h3 class="mod-title">戏曲下载排行榜</h3>
	        	</div>
	        	<div class="mod-bd">
	        		<ul class="text-list">
	        			<li><a href="#" class="text">测试列表列表测试列表列表测试列表</a>	</li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表</a></li>
			...
			<div class="mod online">
				<div class="mod-hd">
	        		<h3 class="mod-title">戏曲在线播放</h3></div>
				<div class="mod-bd">
	        		<ul class="img-list clearfix">
	        			<li>
	        				<a href="#" class="figure"><img src="assets/img/tmp_120x120.jpg" width="120" height="90" /></a>
	        				<a href="#" class="text">测试列表列表测试列表列表测试列表</a>
	        			</li>
	        			<li>
	        				<a href="#" class="figure"><img src="assets/img/tmp_120x120.jpg" width="120" height="90" /></a>
	        				<a href="#" class="text">测试列表列表测试列表列表测试列表</a>	
		...
		<div class="layout clearfix">
			<div class="mod xiqu-intro">
				<div class="mod-hd">
					<h3 class="mod-title">戏曲介绍</h3>
					<span class="more"><a href="#">更多内容 &raquo;</a></span>
				</div>
				<div class="mod-bd">
	        		<ul class="text-list">
	        			<li><a href="#">测试列表列表测试列表列表测试列表</a>	</li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表测试列表列表测试列表列表</a></li>
	        			<li><a href="#">测试列表列表</a></li>
			...
			<div class="mod xiqu-video">
				<div class="mod-hd">
					<h3 class="mod-title">戏曲视频下载</h3>
					<span class="more"><a href="#">更多内容 &raquo;</a></span>
				</div>
				<div class="mod-bd">
	        		<ul class="text-list">
			...
			<div class="mod xiqu-audio">
				<div class="mod-hd">
					<h3 class="mod-title">戏曲MP3下载</h3>
					<span class="more"><a href="#">更多内容 &raquo;</a></span>
				</div>
				<div class="mod-bd">
	        		<ul class="text-list">
		...
		<div class="mod links">
			<div class="mod-hd">
				<h3 class="mod-title">友情链接</h3>
				<span class="more">
					申请友情链接请联系QQ：1074620197
				</span>
			</div>
			<div class="mod-bd">
				<a href="#">戏曲网</a>
